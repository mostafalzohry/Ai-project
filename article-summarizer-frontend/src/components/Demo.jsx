...
//       const newItem = {
//         url,
//         result: data.summary || data[0].transcriptionAsText,
...
//       // Save generated voice to local storage
...
//       const newItem = {
//         url,
//         result: data.summary || data[0]?.transcriptionAsText || "No result available", // Fallback to default text
//         title: data.title || data[0]?.title || "No title available", // Fallback to default text
//         audioUrl: "",
//       };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const newItem = {
        url,
        result:
          data.summary || data[0]?.transcriptionAsText || "No result available", // Fallback to default text
        title: data.title || data[0]?.title || "No title available", // Fallback to default text
        audioUrl: "",
      };
